...
class ViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func createDataDumpOfMatchReports() -> Data {
        ...
        mailString.append("Tournament,Match Number,Team Number,Auto Crossed Line,Auto Fuel High,Auto Fuel Low,Auto Scores Gear,Comments,DefenseFaced,Fuel From Feeder,Fuel From Floor,Fuel From Hopper,Fuel High,Fuel Low,Gear Cycle,Gears,Gears From Feeder,Gears From Floor,Hang,Hang Speed,Match Result,Penalty,Rotors Started,Shots Location,Defense Played,Defense Played Level\n")
